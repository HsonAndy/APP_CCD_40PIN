...
{       
    ...
    MyInput_PIN03.Input_ON = sub_PIN03_ON;
    MyInput_PIN04.Input_ON = sub_PIN04_ON;
    MyInput_PIN05.Input_ON = sub_PIN05_ON;
    MyInput_PIN06.Input_ON = sub_PIN06_ON;
    MyInput_PIN07.Input_ON = sub_PIN07_ON;
    MyInput_PIN08.Input_ON = sub_PIN08_ON;
    MyInput_PIN09.Input_ON = sub_PIN09_ON;
    MyInput_PIN10.Input_ON = sub_PIN10_ON;
...
void sub_IO_Program()
{
     MyInput_PIN03.GetState(0);
     MyInput_PIN04.GetState(0);
     MyInput_PIN05.GetState(0);
     MyInput_PIN06.GetState(0);
     MyInput_PIN07.GetState(0);
     MyInput_PIN08.GetState(0);
     MyInput_PIN09.GetState(0);
     MyInput_PIN10.GetState(0);
